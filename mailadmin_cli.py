...
parser_domains_add.add_argument('name', help='The hostname of the domain to add.', action='store')
...
parser_users_add.add_argument('email', help='The email address of the new user.', action='store')
